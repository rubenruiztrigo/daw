...
export const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] dark:bg-black flex transition-colors duration-200 font-sans overflow-x-hidden">
      ...
      {showSidebar && (
        <aside className="w-80 fixed inset-y-0 right-0 bg-white dark:bg-[#0a0a0a] border-l border-gray-100 dark:border-zinc-900 hidden lg:flex flex-col p-6 z-30 animate-in slide-in-from-right duration-300">
