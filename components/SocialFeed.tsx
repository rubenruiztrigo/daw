...
export const SocialFeed: React.FC<SocialFeedProps> = ({
  ...
  return (
    <div className="pb-20">
      <div className="sticky top-0 z-20 bg-white dark:bg-[#0a0a0a] border-gray-100 dark:border-zinc-900 flex items-center justify-between px-0 mb-4 h-14 -mx-4 sm:-mx-6 md:-mx-8 -mt-3 sm:-mt-4 md:-mt-8">
