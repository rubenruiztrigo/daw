...
export const CalendarView: React.FC<CalendarViewProps> = ({ onNavigateToEvent, onPromoteEvent, onSupportEvent, onShareEvent, initialDate, language }) => {
  ...
  return (
    <div
      className="w-full h-[70vh] flex flex-col lg:flex-row gap-8 animate-in fade-in duration-500 relative touch-none select-none"
    ...
    >
              ...
              {Array.from({ length: numWeeks * 7 }).map((_, i) => {
                ...
                return (
                  <button
                    ...
                    className={`h-full rounded-xl flex flex-col items-center justify-center relative transition-all border-2 ${isSelected
      ...
      <div className="w-full lg:w-96 space-y-4">
        ...
        <div className="space-y-3 overflow-y-auto pr-2 max-h-[calc(70vh-140px)] scrollbar-hide">
