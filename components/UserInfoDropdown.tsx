...
export const UserInfoDropdown: React.FC<UserInfoDropdownProps> = ({ 
  ...
  return (
    <div 
      className="absolute top-full left-0 mt-2 w-72 bg-white dark:bg-[#111] rounded-[2rem] border border-slate-100 dark:border-zinc-800 z-[120] animate-in fade-in zoom-in-95 duration-200 overflow-hidden origin-top-left shadow-none"
