...
export const UserInfoDropdown: React.FC<UserInfoDropdownProps> = ({ 
  ...
  return (
    <div 
      className="absolute top-full left-0 mt-1 w-72 bg-white dark:bg-[#111] rounded-[2rem] shadow-2xl border border-slate-100 dark:border-zinc-800 z-[120] animate-in fade-in zoom-in-95 duration-200 overflow-hidden origin-top-left"
    ...
    >
      ...
      <div className="px-6 pb-6">
        <div className="relative -mt-8 mb-3">
          <img 
            src={userInfo.avatar} 
            className="w-16 h-16 rounded-2xl border-4 border-white dark:border-zinc-800 object-cover shadow-md" 
            alt="" 
          />
        </div>
