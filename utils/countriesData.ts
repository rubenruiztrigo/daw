...
export const COUNTRIES_DATA: Record<string, string[]> = {
    "Alemania": [
        "Baden-Wurtemberg", "Baviera", "Berlín", "Brandeburgo", "Bremen", "Hamburgo",
        "Hesse", "Mecklemburgo-Pomerania Occidental", "Baja Sajonia", "Renania del Norte-Westfalia",
    ...
    "Bélgica": [
        "Flandes", "Región de Bruselas-Capital", "Valonia"
    ],
    "Bolivia": [
    ...
    "Canadá": [
        "Alberta", "Columbia Británica", "Isla del Príncipe Eduardo", "Manitoba", "Nueva Escocia",
        "Nuevo Brunswick", "Nunavut", "Ontario", "Quebec", "Saskatchewan",
        "Terranova y Labrador", "Territorios del Noroeste", "Yukón"
    ],
    "Chile": [
        "Antofagasta", "Arica y Parinacota", "Atacama", "Aysén", "Biobío", "Coquimbo",
        "La Araucanía", "Los Lagos", "Los Ríos", "Magallanes", "Maule", "Metropolitana de Santiago",
    ...
    "España": [
        ...
        "Castilla y León", "Castilla-La Mancha", "Cataluña", "Ceuta", "Comunidad Valenciana",
    ...
    "Estados Unidos": [
        ...
        "Maryland", "Massachusetts", "Míchigan", "Minnesota", "Misisipi", "Misuri", "Montana", "Nebraska",
    ...
    "Francia": [
        "Alta Francia", "Auvernia-Ródano-Alpes", "Borgoña-Franco Condado", "Bretaña",
        "Centro-Valle de Loira", "Córcega", "Gran Este", "Isla de Francia", "Normandía",
        "Nueva Aquitania", "Occitania", "Países del Loira", "Provenza-Alpes-Costa Azul"
    ],
    "Guatemala": [
    ...
    "Italia": [
        ...
        "Friuli-Venecia Julia", "Lacio", "Liguria", "Lombardía", "Marcas", "Molise", "Piamonte",
        "Sicilia", "Toscana", "Trentino-Alto Adigio", "Umbría", "Valle de Aosta", "Véneto"
    ],
    "México": [
    ...
    "Nicaragua": [
        ...
        "Madriz", "Managua", "Masaya", "Matagalpa", "Nueva Segovia", "RACCN", "RACCS", "Rivas",
        "Río San Juan"
    ],
    "Países Bajos": [
        "Brabante Septentrional", "Drente", "Flevoland", "Frisia", "Groninga", "Güeldres",
        "Holanda Meridional", "Holanda Septentrional", "Limburgo", "Overijssel", "Utrecht", "Zelanda"
    ],
    "Panamá": [
    ...
    "Portugal": [
        "Aveiro", "Azores", "Braga", "Coímbra", "Évora", "Faro", "Leiria", "Lisboa",
        "Madeira", "Oporto", "Santarém", "Setúbal", "Viana do Castelo", "Viseu"
    ],
    "Reino Unido": [
        "Escocia", "Gales", "Inglaterra", "Irlanda del Norte"
    ],
    "Suiza": [
        "Appenzell Rodas Exteriores", "Appenzell Rodas Interiores", "Argovia", "Basilea-Campiña",
        "Basilea-Ciudad", "Berna", "Friburgo", "Ginebra", "Glaris", "Grisones", "Jura", "Lucerna",
        "Neuchâtel", "Nidwalden", "Obwalden", "San Galo", "Schaffhausen", "Schwyz", "Soleura",
        "Tesino", "Turgovia", "Uri", "Valais", "Vaud", "Zúrich", "Zug"
    ],
    "Uruguay": [
